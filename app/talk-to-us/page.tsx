                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a href="tel:7506233907" className="text-green-600 hover:underline font-semibold text-lg">
                            7506233907
                          </a>
                        </div>
                      </div>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-4">
                      <Button
                        ...
                        onClick={() => window.open("tel:7506233907")}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => window.open("mailto:Support@fitintraders.com")}
                      >
            ...
            <Card className="mt-12 bg-gradient-to-r from-blue-600 to-green-600 text-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-xl mb-6 opacity-90">
                  Join thousands of successful traders who trust Fitin Traders for expert market insights and research
                  alerts.
                </p>
