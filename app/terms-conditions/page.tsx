            ...
            <Card className="mb-8 shadow-lg border-blue-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  The term <span className="font-semibold">Fitin Traders</span> (or "us" or "we") refers to the owners,
                  managers of the website Fitin Traders and/or Fitin Traders whose office is located at{" "}
                  <span className="font-semibold">
                    Office No. 815, Rupa Solitaire, MBP, Koparkhairane, Thane, Maharashtra – 400710, Maharashtra, India
                  </span>
                  . and owns and manages the website Fitin Traders.
                </p>
              </CardContent>
            </Card>
          </ScrollAnimation>
            ...
            <Card className="mb-8 shadow-lg border-orange-200 bg-orange-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  Research Analyst ("Fitin Traders") is regulated by the Securities and Exchange Board of India ("SEBI")
            ...
            <Card className="mb-8 shadow-lg border-green-200">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  ...
                  <p>
                    The term Fitin Traders is used through this entire Terms and Conditions document to refer to the
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-purple-200">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    Without prejudice to the generality of the foregoing paragraph, Fitin Traders and its owner, directors,
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Fitin Traders does not in any manner whatsoever verify or vouch for the accuracy or authenticity of
                      the results
                    </li>
                    <li>
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-indigo-200">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    The documents/reports/research analysis available on the Website or published/produced by Fitin Traders
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-teal-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  By registering for this facility you understand that Fitin Traders reserves the right, in its sole
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-cyan-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Fitin Traders hereby grants you a limited, non-exclusive, non-assignable, and non-transferable license to
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-red-200">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    Unauthorized use of this Website and systems, including unauthorized entry into Fitin Traders systems,
                  ...
                  <p>
                    Fitin Traders may use certain technology on its websites to collect information from visitors and may
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-yellow-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Fitin Traders reserves its right, in its sole discretion, without any obligation, and without any notice
                  ...
                  improvements or corrections. Fitin Traders shall not be liable for any loss or liability resulting from
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Fitin Traders sources data from Capital Markets and is not responsible for correctness or accuracy
                    </li>
                    <li>NSE data is delayed by 5 minutes and BSE data is delayed by 15 minutes</li>
                    <li>The authenticity of data received from Capital Markets is not guaranteed by Fitin Traders</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-red-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  You agree that Fitin Traders shall not be liable, whether in contract or tort, for any direct, special,
                  ...
                  operator errors, strikes or any force majeure. Fitin Traders cannot guarantee continuous, uninterrupted,
            ...
            <Card className="mb-8 shadow-lg border-blue-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  of the Website. Fitin Traders has not reviewed, nor approved these sites and is not responsible for the
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-purple-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  You shall indemnify, defend and hold harmless Fitin Traders from any claims and losses imposed on,
                  incurred by, or asserted as a result of or related to: (a) your access and use of Fitin Traders (b) any
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      Fitin Traders and its licensors.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-3">Copyright License</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                      Fitin Traders grants you a non-exclusive royalty-free revocable license to:
                    </p>
                    ...
                    <p className="text-gray-700 leading-relaxed mt-3">
                      ...
                      public this website without Fitin Traders's prior written permission.
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-300">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="border border-gray-300 p-4 text-center">
                            Make all payments in the form of cheque/online transfer in the name Fitin Traders only
                          </td>
                          <td className="border border-gray-300 p-4 text-center">
                        ...
                        <tr>
                          <td className="border border-gray-300 p-4 text-center"></td>
                          <td className="border border-gray-300 p-4 text-center">
                            Don't make a cash payment or issue a cheque in the name of any employee of Fitin Traders or any
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-300">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="border border-gray-300 p-4 text-center">
                            Type the entire Fitin Traders address (<span className="text-blue-600">Fitin Traders</span>)
                        ...
                        <tr className="bg-gray-50">
                          <td className="border border-gray-300 p-4 text-center"></td>
                          <td className="border border-gray-300 p-4 text-center">
                            Do not trust a site appearing to belong to Fitin Traders if it doesn't start with the 'HTTPS'
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>
                      ...
                      for Fitin Traders or another legitimate business, asking you to reveal personal information
                    </li>
                    <li>
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3">
                      Fitin Traders may collect and use the following kinds of personal information:
                    </h3>
                    <ul className="list-disc list-inside space-y-2">
                      <li>Information about your use of this website</li>
                      <li>Information that you provide using to register with Fitin Traders</li>
                      ...
                      <li>Any other information that you send to Fitin Traders</li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-bold mb-3">Using personal information</h3>
                    <p className="mb-3">Fitin Traders may use your personal information to:</p>
                    <ul className="list-disc list-inside space-y-2">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li>
                        Fitin Traders will take reasonable technical and organizational precautions to prevent the loss,
                        misuse, or alteration of your personal information
                      </li>
                      <li>Fitin Traders will store all the personal information you provide on its secure servers</li>
                      <li>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    ...
                    written agreement existing between you and Fitin Traders. By using the information on Fitin Traders, you
                  ...
                  <p>
                    Fitin Traders does not guarantee the accuracy, completeness or timeliness of, or otherwise endorse in
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">
                      Fitin Traders is not a registered broker-dealer under the U.S. Securities Exchange Act of 1934, as
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      services provided by Fitin Traders, including the products and services described herein are not
                  ...
                  <div className="bg-white p-6 rounded-lg border-l-4 border-green-500">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Fitin Traders is not a registered adviser or dealer under applicable Canadian securities laws nor has
                      it obtained an exemption from the adviser and/or dealer registration requirements under such law.
                      Accordingly, any services provided by Fitin Traders, including the products and services described
              ...
              <CardContent className="p-8">
                ...
                <div className="bg-white p-6 rounded-lg border-l-4 border-red-500">
                  <p className="text-lg text-gray-800 leading-relaxed">
                    ...
                    research alerts published by Fitin Traders) do not constitute an offer or invitation to purchase or
                    subscribe for any securities or solicitation of any investments or investment services. Fitin Traders
                    ...
                    fees once paid will not be refunded under any circumstances and Fitin Traders and its owner/proprietor
                    will not be responsible for any losses incurred to its clients in any condition. The clients are at
                    their own risk for trading based on Fitin Traders's research reports and/or research alerts and they
                    cannot file any type of legal case or complaint against the Fitin Traders or owner/proprietor of
                    Fitin Traders in any part of the country."
                  </p>
                </div>
              </CardContent>
            </Card>
