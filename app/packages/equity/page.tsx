              ...
              <CardContent className="p-8">
                ...
                <div className="max-w-4xl mx-auto space-y-6 text-lg leading-relaxed text-gray-700">
                  <p className="text-xl font-semibold text-center text-gray-900">
                    Dear Customer, Greetings from Fitin Traders!!!
                  </p>
                  <p>
                    ...
                    communications from Fitin Traders will only be sent from the email address:{" "}
                    <a href="mailto:sales@fitintraders.com" className="text-blue-600 hover:underline font-semibold">
