          ...
          <ScrollAnimation direction="right">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Before embarking on your stock market journey using Fitin Traders's research alerts and reports, it's
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        <a href="mailto:compliance@fitintraders.com" className="text-blue-600 hover:underline">
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-12 shadow-lg border-green-200 bg-gradient-to-br from-green-50 to-blue-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  All our research recommendations are delivered exclusively through the Fitin Traders mobile app. Please
            ...
            <Card className="shadow-lg bg-gradient-to-r from-green-600 to-blue-600 text-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-xl leading-relaxed">
                  ...
                  Fitin Traders encourages you to prioritize risk management and smart investing for a profitable trading
                  experience.
                </p>
              </CardContent>
            </Card>
