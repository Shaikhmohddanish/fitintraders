            ...
            <ScrollAnimation direction="left">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Keep track of every trade with Fitin Traders, where transparency and security are our top priorities.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <ScrollAnimation direction="left">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Welcome to <span className="font-semibold">Fitin Traders</span>, your trusted partner in share market
                  research and analysis. At Fitin Traders, we are dedicated to providing top-notch, data-driven insights
        ...
        <div className="container px-4 md:px-6">
          ...
          <ScrollAnimation direction="left">
            <div className="max-w-3xl mx-auto space-y-4">
              <p className="text-lg">
                Dear Valued Customer, Greetings from <span className="font-semibold">Fitin Traders</span>!
              </p>
              <p>
              ...
              <p>
                ...
                <a href="tel:7506233907" className="text-green-600 hover:underline">
                  7506233907
                </a>{" "}
                or via email at{" "}
                <a href="mailto:sales@fitintraders.com" className="text-green-600 hover:underline">
              ...
              <p>
                Thank you for your attention and continued trust in <span className="font-semibold">Fitin Traders</span>.
              </p>
            </div>
          </ScrollAnimation>
        </div>
            ...
            <ScrollAnimation direction="right">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  <span className="font-semibold">Fitin Traders</span>! Receive personalized, professional support
